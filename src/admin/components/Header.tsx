...
import React from 'react';
import { FiArrowLeft, FiBell } from 'react-icons/fi';
import { Avatar, Breadcrumb, Button, Space, Badge, Input, Dropdown, type MenuProps } from 'antd';
import { HomeOutlined, UserOutlined, LogoutOutlined, UserSwitchOutlined } from '@ant-design/icons';
